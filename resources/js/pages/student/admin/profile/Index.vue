<template>
    <section class="max-w-5xl mx-auto">
        ...
        <student-admin-profile-refunds
            v-if="useRefundSection"
            :purchases="purchases"
        >
...
<script>
    import StudentAdminProfileRefunds from "../../../../components/student/admin/profile/Refunds";

    export default {
        name: "StudentAdminProfileIndex",
        layout: 'student-admin-layout',
        components: {
            StudentAdminProfileRefunds
        },
        props: {
            auth: Object,
            profile: Object,
            purchases: Object,
            useRefundSection: Boolean,
        }
    }
</script>
