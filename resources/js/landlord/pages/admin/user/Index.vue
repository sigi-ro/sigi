    ...
    <section>
        ...
        >
            ...
            <inertia-link
                ...
                "
                :href="$route('landlord.admin.users.create')"
            >
                                ...
                                <td v-if="show_users_actions">
                                    <div class="flex flex-row items-center justify-end -mx-1">
                                        <inertia-link
                                            ...
                                            "
                                            :href="$route('landlord.admin.users.edit', user.id)"
                                            title="Edit User"
                                        >
                                            <icon-edit
                                                class="w-4"
    ...
    export default {
        ...
        methods: {
            ...
            confirmUserDelete() {
                ...
                this.$inertia.delete(
                    this.$route('landlord.admin.users.destroy', this.userToDelete.id),
                    {
                        only: [
                            'flash',
                            'users'
            ...
            onSearchOptionsUpdate: _.debounce(function () {
                ...
                router.get(
                    this.$route('landlord.admin.users.index'),
